...
$id=$_REQUEST['id'];
$image_list = DB::query("SELECT * FROM ".DB::table('add_portal_module')." where id=".$id);
...
<form action="imageSubmit.php?act=modify" method='post' name="images"  onsubmit="return checkdata(images);">
	<div class="sharetck">
		...
		<div class="discusejian1_content_one" style="height:40px;">
			...
			<div class="discusejian1_content_two">
				...
				<div class="discusejian1_content_three_right">
					<input type="text" name='orderby' id='orderby' maxlength='1'  value="<?php echo $data[0]['display'];?>" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
