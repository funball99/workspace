...
{?>
	...
	<div id='discuz_check' >
		...
		<a href="image.php" class="discuse_content_moduleslink" id="isFrameImg">+&nbsp;<?php echo Common::get_web_unicode_charset('\u70b9\u51fb\u6dfb\u52a0\u5e7b\u706f\u7247')?></a>
		...
		?>
			<li>
				...
				<div class="discuse_content_a">
					<a href="imageEdit.php?id=<?php echo $val['id'];?>" class="discuse_content_left"  ><?php echo Common::get_web_unicode_charset('\u7f16\u8f91')?></a>
					<a class="discuse_content_right" href="imageDelete.php?id=<?php echo $val['id'];?>" onclick='return delconfirm()'><?php echo Common::get_web_unicode_charset('\u5220\u9664');?></a>
	...
	<div class="discuse_content">
		...
		<a href="module.php" class="discuse_content_moduleslink"  id="isFrame">+&nbsp;<?php echo Common::get_web_unicode_charset('\u70b9\u51fb\u6dfb\u52a0\u8d44\u8baf\u5206\u7c7b')?></a>
		<ul class="discuse_content_ulimg">
		<?php 
		...
		?>
			<li>
				<div class="discuse_content_show">
					...
					<a href="moduleList.php?mid=<?php echo $val['id'];?>" title="<?php echo Common::get_web_unicode_charset($val['mname']); ?>"><?php echo sub_str(Common::get_web_unicode_charset($val['mname']),0,16);//?></a>
				</div>
				<div class="discuse_content_b">
				
					<a href='moduleEdit.php?id=<?php echo $val['id'];?>' class="discuse_content_left_b" ><?php echo Common::get_web_unicode_charset('\u7f16\u8f91')?></a>
					<a class="discuse_content_right_b" href="moduleDelete.php?id=<?php echo $val['id'];?>" onclick='return delconfirm()'><?php echo Common::get_web_unicode_charset('\u5220\u9664')?></a>
				</div>
			</li>
		<?php 
		...
		<div class="discuse_button">
			<div class="discuse_buttons">
				...
				<input class="quit" type="reset" value ='' style="cursor:pointer"/>
			</div>
		</div>
	</form>
</body>
