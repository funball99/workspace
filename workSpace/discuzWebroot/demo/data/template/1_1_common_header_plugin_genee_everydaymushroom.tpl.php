...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1386488863, '1', './data/template/1_1_common_header_plugin_genee_everydaymushroom.tpl.php', './template/default', 'common/header_plugin_genee_everydaymushroom')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1386488863, '1', './data/template/1_1_common_header_plugin_genee_everydaymushroom.tpl.php', './template/default', 'common/header_plugin_genee_everydaymushroom')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1386488863, '1', './data/template/1_1_common_header_plugin_genee_everydaymushroom.tpl.php', './template/default', 'common/header_plugin_genee_everydaymushroom')
;?>
