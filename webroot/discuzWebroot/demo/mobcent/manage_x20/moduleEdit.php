...
$id=$_REQUEST['id'];
$newstype_list = DB::query("SELECT * FROM ".DB::table('add_module')." where id=".$id);
...
<body>
<form action ='moduleSubmit.php?act=modify' method ='post' name="module" onsubmit="return checkdata(module);">
	<div class="sharetck">
