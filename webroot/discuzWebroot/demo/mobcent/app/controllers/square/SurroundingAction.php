...
class SurroundingAction extends CAction
{
                                   ...
                                   $page, $pageSize)
    {
        ...
        foreach ($surroundUsers as $user) {
            ...
            if (UserUtils::isGPSLocationOn($tmpUid)) {
                $userInfo['uid'] = $tmpUid;
                                    ...
                                    $page, $pageSize)
    {
        ...
        $count = SurroundingInfo::getTopicCountByTid($longitude, $latitude, $radius);
        $surroundTopics = SurroundingInfo::getAllTopicsByTid($longitude, $latitude, $radius, $page, $pageSize);
        ...
        foreach ($surroundTopics as $topic) {
            ...
            if (!empty($tmpTopicInfo)) {
            	...
            	if ($tmpUid != $uid && UserUtils::isGPSLocationOn($tmpUid)) {
