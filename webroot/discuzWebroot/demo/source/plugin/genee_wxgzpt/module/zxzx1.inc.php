...
global $_G;
$postlist = DB::fetch_all ( "SELECT subject,message,authorid,pid,author,dateline,position,tid FROM " . DB::table ( 'forum_post' ) . " WHERE invisible!=-5  ORDER BY dateline DESC LIMIT 10 " );
