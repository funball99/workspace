...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1389137312, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/singcere_note', 'common/header_portal_index')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_qmenu.htm', 1389137312, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/singcere_note', 'common/header_portal_index')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/singcere_note/common/pubsearchform.htm', 1389137312, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/singcere_note', 'common/header_portal_index')
;?>
