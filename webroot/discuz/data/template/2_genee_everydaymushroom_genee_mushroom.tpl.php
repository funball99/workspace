...
0
|| checktplrefresh('./source/plugin/genee_everydaymushroom/template/genee_mushroom.htm', './template/singcere_note/common/header.htm', 1389100439, 'genee_everydaymushroom', './data/template/2_genee_everydaymushroom_genee_mushroom.tpl.php', './source/plugin/genee_everydaymushroom/template', 'genee_mushroom')
|| checktplrefresh('./source/plugin/genee_everydaymushroom/template/genee_mushroom.htm', './template/default/common/seditor.htm', 1389100439, 'genee_everydaymushroom', './data/template/2_genee_everydaymushroom_genee_mushroom.tpl.php', './source/plugin/genee_everydaymushroom/template', 'genee_mushroom')
|| checktplrefresh('./source/plugin/genee_everydaymushroom/template/genee_mushroom.htm', './template/singcere_note/common/footer.htm', 1389100439, 'genee_everydaymushroom', './data/template/2_genee_everydaymushroom_genee_mushroom.tpl.php', './source/plugin/genee_everydaymushroom/template', 'genee_mushroom')
|| checktplrefresh('./source/plugin/genee_everydaymushroom/template/genee_mushroom.htm', './template/default/common/header_common.htm', 1389100439, 'genee_everydaymushroom', './data/template/2_genee_everydaymushroom_genee_mushroom.tpl.php', './source/plugin/genee_everydaymushroom/template', 'genee_mushroom')
|| checktplrefresh('./source/plugin/genee_everydaymushroom/template/genee_mushroom.htm', './template/default/common/header_qmenu.htm', 1389100439, 'genee_everydaymushroom', './data/template/2_genee_everydaymushroom_genee_mushroom.tpl.php', './source/plugin/genee_everydaymushroom/template', 'genee_mushroom')
|| checktplrefresh('./source/plugin/genee_everydaymushroom/template/genee_mushroom.htm', './template/singcere_note/common/pubsearchform.htm', 1389100439, 'genee_everydaymushroom', './data/template/2_genee_everydaymushroom_genee_mushroom.tpl.php', './source/plugin/genee_everydaymushroom/template', 'genee_mushroom')
;?>
...
<div id="page"><?php echo adshow("headerbanner/wp a_h");?><?php $mnid = getcurrentnav();?>  <div id="header">
    <div class="toplogo">
        <div class="row">
          <div class="branding">
...
<?php if(!empty($_G['setting']['pluginhooks']['global_usernav_extra3'])) echo $_G['setting']['pluginhooks']['global_usernav_extra3'];?><?php if(!empty($_G['setting']['pluginhooks']['global_usernav_extra4'])) echo $_G['setting']['pluginhooks']['global_usernav_extra4'];?><span class="pipe">|</span><a href="home.php?mod=space&amp;do=notice" id="myprompt"<?php if($_G['member']['newprompt']) { ?> class="new"<?php } ?>  onmouseover="showMenu({'ctrlid':'myprompt'});">提醒<?php if($_G['member']['newprompt']) { ?>(<?php echo $_G['member']['newprompt'];?>)<?php } ?></a><span id="myprompt_check"></span>
<?php if(empty($_G['cookie']['ignore_notice']) && ($_G['member']['newpm'] || $_G['member']['newprompt_num']['follower'] || $_G['member']['newprompt_num']['follow'] || $_G['member']['newprompt'])) { ?><script language="javascript">delayShow($('myprompt'), function() {showMenu({'ctrlid':'myprompt','duration':3})});</script><?php } if($_G['setting']['taskon'] && !empty($_G['cookie']['taskdoing_'.$_G['uid']])) { ?><span class="pipe">|</span><a href="home.php?mod=task&amp;item=doing" id="task_ntc" class="new">进行中的任务</a>
<?php } ?>
...
<div class="ad1"><a href="<?php echo $ad['ad1']['adlink'];?>" target="_blank"><img src="<?php echo $ad['ad1']['adsrc'];?>" /></a></div>
...
<p class="con_list01" style="color: blue;">您现在身上还有<span class="span_a3" id="geneemoney"><?php echo $geneemoney['extcredits'.$gvar['exttype']];?></span><?php echo $credittype;?></p>
...
<div class="ad2"><a href="<?php echo $ad['ad2']['adlink'];?>" target="_blank"><img src="<?php echo $ad['ad2']['adsrc'];?>" /></a></div>
...
<p class="xs0">&copy; 2001-2013 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a> Design <a href="http://singcere.net">Singcere!</a></p>
