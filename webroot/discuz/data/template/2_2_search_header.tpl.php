...
0
|| checktplrefresh('./template/default/search/header.htm', './template/default/common/header_common.htm', 1389468288, '2', './data/template/2_2_search_header.tpl.php', './template/singcere_note', 'search/header')
;?>
