...
$_config['db']['1']['dbuser'] = 'discuzroot';
$_config['db']['1']['dbpw'] = '0450278329d';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'wZdg_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = 'c3bed8CzyJWS2T91';
